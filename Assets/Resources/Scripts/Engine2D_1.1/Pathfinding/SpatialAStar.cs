namespace Engine.Pathfinding {
  ...
  public class SpatialAStar<TPathNode, TUserContext> where TPathNode: IPathNode<TUserContext> {
    ...
    /// </summary>
    public LinkedList<TPathNode> Search(Vector2 start, Vector2 end, TUserContext inUserContext) {
      PathNode startNode = m_SearchSpace[(int)start.x, (int)start.y];
      PathNode endNode = m_SearchSpace[(int)end.x, (int)end.y];
